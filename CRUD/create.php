...
<body>
    ...
    <section class="colored-section">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col">
                            <input id="scientific_name" name="scientific_name" type="text" class="form-control"
                                maxlength="40" placeholder="Indiquez le nom scientifique" required />
                        </div>
              ...
              ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col">
                            <input id="common_name_en" name="common_name_en" type="text" class="form-control"
                                maxlength="40" placeholder="Indiquez le nom en anglais" required />
                        </div>
                    </div>
                    <br />
                    <div class="row g-3">
                        ...
                        <div class="col">
                            <input id="common_name_fr" name="common_name_fr" type="text" class="form-control"
                                maxlength="40" placeholder="Indiquez le nom en français" required />
                        </div>
                    </div>
                    <br />
                    <div class="row g-3">
                        ...
                        <div class="col">
                            <input id="common_name_ru" name="common_name_ru" type="text" class="form-control"
                                maxlength="40" placeholder="Indiquez le nom en russe" required />
                        </div>
                    </div>
                    <br />
                    <br />
                ...
                <fieldset>
                    ...
                    <div class="mb-3">
                        <textarea id="note" name="note" class="form-control"
                            placeholder="Dites-nous ce que vous en pensez !"></textarea>
                    </div>
                </fieldset>
      ...
      { 
        ...
        if($requete){
          echo "<h5>L'insertion s'est bien déroulée !</h5>"; 
        }else{
          echo "<h5>Erreur lors de l'insertion</h5>"; 
        }
